...
"""
v3.1.4版本修改 (Based on v3.1.3)

1. 集成 PhysicsIntentModule (物理意图感知模块)
2. 在 Encoder 和 Decoder 中利用 COG 和 Lane_Dir 进行动态意图交互
3. 修复了单纯线性叠加环境特征导致的"平均化/走直线"问题
"""
    ...
    def forward(self, x_enc, y_truth_abs, mask_x, mask_y, A_social_t=None, edge_features=None):
        ...
        for t in range(self.pred_len):
            ...
            if use_truth:
                ...
                true_delta = next_abs_pos - y_input_abs
